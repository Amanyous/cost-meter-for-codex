...
[![version](https://img.shields.io/badge/version-1.7.24-4176E6)](https://github.com/Han-1413141/dsh-cost-meter)

**v1.7.24** discovers OpenCode Go credentials from your official Go route, regardless of its name. See [credential discovery](docs/opencode-go-credentials.md#english). See the [recovery guide](docs/session-history-recovery.md#english) for sessions affected by the earlier native-search log issue.
...
**PowerShell one-click script** (copy the whole line, paste, press Enter; pnpm is provisioned automatically, git is auto-detected — no clone needed; the install chain is **pinned to the release tag `v1.7.24`** — review the script before running):
...
```sh
dsh plugin --profile web add github:Han-1413141/dsh-cost-meter#v1.7.24
```

Without git, use the GitHub tag archive:

```sh
dsh plugin --profile web add https://github.com/Han-1413141/dsh-cost-meter/archive/refs/tags/v1.7.24.tar.gz
```
